...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    api.sendMessage("__-চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ 𝐌𝐀𝐒𝐇𝐈𝐊 ☢️ 𝐂𝐇𝐀𝐓_𖣘 -𝐁𝐎𝐓 ⚠️ এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ-!!", threadID, () => {
...
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: https://wa.me/0197993****

❖⋆═══════════════════════⋆❖
          𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ 𝐌𝐀𝐒𝐇𝐈𝐊-𝐌𝐀𝐇𝐈𝐑`;
